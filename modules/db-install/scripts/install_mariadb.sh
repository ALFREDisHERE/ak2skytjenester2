...
DB_NAME="example_db"
username="adminbruker" # Bytt til et passende brukernavn (Se READMS)
...
# Insert sample data
sudo mysql -e "USE ${DB_NAME}; INSERT INTO employees (name, position, salary) VALUES ('Havard', 'Engineer', 75000), ('Alfred', 'Manager', 85000), ('Sondre', 'Løpegutt', 76000), ('Christopher', 'department of govurment efficiency', 95000), ('yay det funker!', 'yay', 95000), ('God jul!', 'department of govurment efficiency', 95000);"
