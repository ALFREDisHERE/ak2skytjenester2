...
admin_username      = "adminbruker" # Sett til et passende brukernavn (må endres til lik verdi i playbook.yml og install_mariadb.sh, se README filen)
admin_password = "Passord123" # Sett til et passende passord (må endres til lik verdi i playbook.yml og install_mariadb.sh, se README filen)
